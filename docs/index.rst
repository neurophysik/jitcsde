...
It takes an iterable (or generator functions) of `SymPy <http://www.sympy.org/>`_ expressions, translates them to C code, compiles them and an integrator wrapped around them on the fly, and allows you to operate this integrator from Python.
...
*	**SymPy interface**
	...
	Also, if you are working with SymPy anyway – e.g., to calculate points of zero drift –, you do not need to bother much with translating your equations.
...
This documentation assumes that the Itō stochastic differential equation (SDE) you want to solve is:
